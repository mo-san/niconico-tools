...
class NicoMyList(LogIn):
    ...
    def _confirmation(self, mode: str, list_name: str, contents_to_be_deleted: Optional[List[str]]=...) -> bool: ...
    def _should_continue(self, res: Dict, video_id: str, list_name: str, count_now: int, count_whole: int) -> bool: ...
    def get_response(self, mode: str, is_def: bool, list_id_to: int, video_or_item_id: Optional[str],
                     list_id_from: Optional[int]=...) -> Dict: ...
    def create_mylist(self, mylist_name: str, is_public: Optional[bool]=..., desc: Optional[str] = ...) -> bool: ...
    ...
    def _copy_or_move(self, is_copy: bool, list_id_from: MylistId, list_id_to: MylistId,
    ...
    def show_meta(self) -> List[List[str]]:
        ...
        ...
    def show(self, list_id: MylistId, with_header: bool=...) -> List[List[str]]:
        container = ...  # type: List[List[str]]
        ...
    def show_all_through(self, with_info=...) -> List[List[str]]: ...
